...
const translations = {
  en: {
    ...
    'dsgvo.p5d':     'Form submissions are transmitted via the third-party provider <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, USA)</strong> and processed on their servers. Formspree acts as a data processor pursuant to Art. 28 GDPR. Data transfer to the USA is based on the EU Commission\'s Standard Contractual Clauses (Art. 46(2)(c) GDPR). Formspree privacy policy: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
  ...
  tr: {
    ...
    'dsgvo.p5d':     'Form gönderimleri, üçüncü taraf sağlayıcı <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, ABD)</strong> aracılığıyla iletilmekte ve onların sunucularında işlenmektedir. Formspree, GDPR Mad. 28 uyarınca veri işleyici olarak hareket eder. ABD\'ye veri aktarımı, AB Komisyonu\'nun Standart Sözleşme Hükümleri\'ne (GDPR Mad. 46(2)(c)) dayanmaktadır. Formspree gizlilik politikası: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
  ...
  de: {
    ...
    'dsgvo.p5d':     'Die Daten werden über den Drittanbieter <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, USA)</strong> übermittelt und auf dessen Servern verarbeitet. Formspree handelt als Auftragsverarbeiter gemäß Art. 28 DSGVO. Die Übertragung in die USA erfolgt auf Grundlage der Standardvertragsklauseln der EU-Kommission (Art. 46 Abs. 2 lit. c DSGVO). Datenschutzerklärung von Formspree: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
