...
const revealEls = document.querySelectorAll(
  '.card, .work__card, .step, .testimonial, .about__card, .highlight, .value__card, .pricing__card, .empty-state, .first-client, .section__header, .faq__item, .stats__item, .contact__item, .contact__form-wrap, .contact__social, .contact__trust, .about__text, .cta-banner__inner, .legal-block, .pricing__compare, .pricing__cta'
);
...
const translations = {
  en: {
    ...
    'form.budget.opt1': 'Under €1,500',
    'form.budget.opt2': '€1,500 – €3,000',
    'form.budget.opt3': '€3,000 – €6,000',
    'form.budget.opt4': '€6,000+',
    ...
    'impressum.h.vat':               'VAT',
    'impressum.h.profession':        'Activity',
    ...
    'impressum.p4':  'Web Designer / Web Developer (not a regulated profession under EU professional recognition law)',
    ...
    'dsgvo.p3c':     'Our host: <strong>Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA</strong>. Data transfer to the USA is based on the EU Commission\'s Standard Contractual Clauses pursuant to Art. 46(2)(c) GDPR. Further information: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">vercel.com/legal/privacy-policy</a>',
    ...
    'dsgvo.p5d':     'Form submissions are first processed via a serverless function of our hosting provider <strong>Vercel Inc.</strong> to technically receive and internally structure the inquiry. The data is then transmitted to us via the third-party provider <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, USA)</strong> and processed on their servers. Formspree acts as a data processor pursuant to Art. 28 GDPR. Data transfer to the USA is based on the EU Commission Standard Contractual Clauses (Art. 46(2)(c) GDPR). Formspree privacy policy: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
  ...
  tr: {
    ...
    'impressum.h.vat':               'KDV',
    'impressum.h.profession':        'Faaliyet',
    ...
    'impressum.p4':  'Web Tasarımcı / Web Geliştirici (AB mesleki tanıma hukuku kapsamında düzenlenmiş bir meslek değildir)',
    ...
    'dsgvo.p3c':     'Host\'umuz: <strong>Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, ABD</strong>. ABD\'ye veri aktarımı, GDPR Mad. 46(2)(c) uyarınca AB Komisyonu\'nun Standart Sözleşme Hükümleri\'ne dayanmaktadır. Daha fazla bilgi: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">vercel.com/legal/privacy-policy</a>',
    ...
    'dsgvo.p5d':     'Form gönderimleri önce hosting sağlayıcımız <strong>Vercel Inc.</strong> tarafından sağlanan bir serverless function üzerinden teknik olarak alınır ve dahili olarak yapılandırılır. Ardından veriler üçüncü taraf sağlayıcı <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, ABD)</strong> aracılığıyla bize iletilir ve onların sunucularında işlenir. Formspree, GDPR Mad. 28 uyarınca veri işleyici olarak hareket eder. ABD’ye veri aktarımı, AB Komisyonunun Standart Sözleşme Hükümlerine (GDPR Mad. 46(2)(c)) dayanmaktadır. Formspree gizlilik politikası: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
  ...
  de: {
    ...
    'impressum.h.profession':        'Tätigkeit',
    ...
    'impressum.p4':  'Webdesigner / Webentwickler (kein reglementierter Beruf im Sinne des EU-Berufsanerkennungsrechts)',
    ...
    'dsgvo.p3c':     'Unser Hoster: <strong>Vercel Inc., 340 S Lemon Ave #4133, Walnut, CA 91789, USA</strong>. Die Datenübertragung in die USA erfolgt auf Grundlage der Standardvertragsklauseln der EU-Kommission gemäß Art. 46 Abs. 2 lit. c DSGVO. Weitere Informationen: <a href="https://vercel.com/legal/privacy-policy" target="_blank" rel="noopener noreferrer">vercel.com/legal/privacy-policy</a>',
    ...
    'dsgvo.p5d':     'Die Formularanfrage wird zunächst über eine Serverless-Funktion unseres Hosting-Anbieters <strong>Vercel Inc.</strong> verarbeitet, um die Anfrage technisch entgegenzunehmen und intern zu strukturieren. Anschließend werden die Daten über den Drittanbieter <strong>Formspree Inc. (548 Market St, Suite 51543, San Francisco, CA 94104, USA)</strong> an uns übermittelt und auf dessen Servern verarbeitet. Formspree handelt als Auftragsverarbeiter gemäß Art. 28 DSGVO. Die Übertragung in die USA erfolgt auf Grundlage der Standardvertragsklauseln der EU-Kommission (Art. 46 Abs. 2 lit. c DSGVO). Datenschutzerklärung von Formspree: <a href="https://formspree.io/legal/privacy-policy" target="_blank" rel="noopener noreferrer">formspree.io/legal/privacy-policy</a>',
