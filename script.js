...
const translations = {
  en: {
    ...
    // Datenschutz body
    'dsgvo.p1':      'The controller for data processing on this website is:<br><br>[First Name Last Name]<br>[Street and House Number]<br>[Postal Code] [City]<br>Germany<br><br>Email: <a href="mailto:[your@email.de]">[your@email.de]</a><br>Phone: [+49 ...]',
    ...
    'dsgvo.p3c':     'Our host: <strong>[Name and address of host]</strong>',
    ...
    'dsgvo.p6.list': '<li><strong>theme</strong> – Your chosen colour scheme (light or dark mode)</li><li><strong>lang</strong> – Your chosen language (EN/TR)</li>',
    ...
    'dsgvo.p7a':     'This website uses Google Fonts, a service of Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. The fonts are loaded directly from Google\'s servers when the website is accessed. Your IP address is transmitted to Google in the process.',
    'dsgvo.p7b':     'The legal basis is Art. 6(1)(f) GDPR (legitimate interest in a uniform and appealing presentation of the website). Further information can be found in Google\'s privacy policy: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>',
    'dsgvo.p7c':     'Note: To completely avoid data transfer to Google, fonts can alternatively be integrated locally. We recommend this for privacy-compliant versions of our projects.',
    ...
    'dsgvo.p8b':     'To exercise your rights, please contact: <a href="mailto:[your@email.de]">[your@email.de]</a>',
  ...
  tr: {
    ...
    // Datenschutz body
    'dsgvo.p1':      'Bu web sitesindeki veri işlemenin sorumlusu:<br><br>[Ad Soyad]<br>[Sokak ve Bina No]<br>[Posta Kodu] [Şehir]<br>Almanya<br><br>E-posta: <a href="mailto:[email@adresiniz.de]">[email@adresiniz.de]</a><br>Telefon: [+49 ...]',
    ...
    'dsgvo.p3c':     'Host\'umuz: <strong>[Host\'un adı ve adresi]</strong>',
    ...
    'dsgvo.p6.list': '<li><strong>theme</strong> – Seçtiğiniz renk şeması (aydınlık veya karanlık mod)</li><li><strong>lang</strong> – Seçtiğiniz dil (EN/TR)</li>',
    ...
    'dsgvo.p7a':     'Bu web sitesi, Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, ABD tarafından sunulan Google Fonts hizmetini kullanmaktadır. Web sitesine erişildiğinde yazı tipleri doğrudan Google sunucularından yüklenir. Bu işlem sırasında IP adresiniz Google\'a iletilir.',
    'dsgvo.p7b':     'Hukuki dayanak, GDPR Mad. 6(1)(f)\'dir (web sitesinin tekdüze ve çekici sunumundaki meşru menfaat). Daha fazla bilgi için Google\'ın gizlilik politikasına bakınız: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>',
    'dsgvo.p7c':     'Not: Google\'a veri aktarımını tamamen önlemek için yazı tipleri alternatif olarak yerel olarak entegre edilebilir. Projelerimizin gizliliğe uyumlu sürümleri için bunu öneriyoruz.',
    ...
    'dsgvo.p8b':     'Haklarınızı kullanmak için lütfen şu adrese başvurun: <a href="mailto:[email@adresiniz.de]">[email@adresiniz.de]</a>',
  ...
  de: {
    ...
    // Datenschutz body
    'dsgvo.p1':      'Verantwortlicher für die Datenverarbeitung auf dieser Website ist:<br><br>[Vorname Nachname]<br>[Straße und Hausnummer]<br>[PLZ] [Stadt]<br>Deutschland<br><br>E-Mail: <a href="mailto:[ihre@email.de]">[ihre@email.de]</a><br>Telefon: [+49 ...]',
    ...
    'dsgvo.p3c':     'Unser Hoster: <strong>[Name und Adresse des Hosters]</strong>',
    ...
    'dsgvo.p6.list': '<li><strong>theme</strong> – Ihre gewählte Farbdarstellung (Hell- oder Dunkelmodus)</li><li><strong>lang</strong> – Ihre gewählte Sprache (EN/TR)</li>',
    ...
    'dsgvo.p7a':     'Diese Website verwendet Google Fonts, einen Dienst der Google LLC, 1600 Amphitheatre Parkway, Mountain View, CA 94043, USA. Die Schriftarten werden beim Aufruf der Website direkt von Google-Servern geladen. Dabei wird Ihre IP-Adresse an Google übertragen.',
    'dsgvo.p7b':     'Rechtsgrundlage ist Art. 6 Abs. 1 lit. f DSGVO (berechtigtes Interesse an einer einheitlichen und ansprechenden Darstellung der Website). Weitere Informationen finden Sie in der Datenschutzerklärung von Google: <a href="https://policies.google.com/privacy" target="_blank" rel="noopener noreferrer">https://policies.google.com/privacy</a>',
    'dsgvo.p7c':     'Hinweis: Um den Datentransfer an Google vollständig zu vermeiden, können Schriftarten alternativ lokal eingebunden werden. Wir empfehlen dies für datenschutzkonforme Varianten unserer Projekte.',
    ...
    'dsgvo.p8b':     'Zur Ausübung Ihrer Rechte wenden Sie sich bitte an: <a href="mailto:[ihre@email.de]">[ihre@email.de]</a>',
